...
{   
    ...
    private byte m_IncEsquerda, m_IncDireita;
    ...
    {
        this.m_Item = p_Item;
        m_Esquerda = m_Direita = null;
        m_IncEsquerda = m_IncDireita = Inclinacao.VERTICAL;
    }
    ...
    /**
     * @return valor da inclinação à Esquerda
     * @see No.Inclinacao
     */
    public byte getIncEsquerda()
    {
        return this.m_IncEsquerda;
    }
    
    /**
     * @param p_Inclinacao valor da inclinação à Esquerda
     * @see No.Inclinacao
     */
    public void setIncEsquerda(byte p_Inclinacao)
    {
        this.m_IncEsquerda = p_Inclinacao;
    }
    
    /**
     * @return valor da inclinação à Direita
     * @see No.Inclinacao
     */
    public byte getIncDireita()
    {
        return this.m_IncDireita;
    }
    
    /**
     * @param p_Inclinacao valor da inclinação à Direita
     * @see No.Inclinacao
     */
    public void setIncDireita(byte p_Inclinacao)
    {
        this.m_IncDireita = p_Inclinacao;
    }
}
